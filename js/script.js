      ...
      <div class="result-container">
        <section class="result">
          <section class="profile-result">
            ...
            <div class="profile_result_pseudo_container">
            <div class="profile_result_pseudo">
              <h2 class="pseudo">${data.login}</h2>
              <p class="pseudo_twitter">${
                data.twitter_username ? data.twitter_username : "Not available"
              }</p>
            </div>
            <div class="profile_creation"><p>Joined ${dateSplit[2]} ${
        dateSplit[1]
      } ${dateSplit[3]}</p></div>
          </div>
        </section>
        ...
        <section class="profile_stats_container">
          <div class="profile_stat_repos">
            <p class="profile_stat_text">Repos</p>
            <p class="profile_stat_number">${
              data.public_repos ? data.public_repos : "0"
            }</p>
          </div>
          <div class="profile_stat_follower">
            <p class="profile_stat_text">Followers</p>
            <p class="profile_stat_number">${
              data.followers ? data.followers : "0"
            }</p>
          </div>
          <div class="profile_stat_following">
            <p class="profile_stat_text">Following</p>
            <p class="profile_stat_number">${
